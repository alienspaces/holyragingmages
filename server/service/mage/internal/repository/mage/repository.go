...
// NewRecord -
func (r *Repository) NewRecord() *record.Mage {
	return &record.Mage{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.Mage {
	return []*record.Mage{}
}

// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.Mage, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.Mage, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.Mage) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.Mage) error {
...
func (r *Repository) CreateTestRecord(rec *record.Mage) error {
