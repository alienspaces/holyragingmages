...
// NewRecord -
func (r *Repository) NewRecord() *record.Entity {
	return &record.Entity{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.Entity {
	return []*record.Entity{}
}

// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.Entity, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.Entity, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.Entity) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.Entity) error {
...
func (r *Repository) CreateTestRecord(rec *record.Entity) error {
