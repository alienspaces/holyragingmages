...
// NewRecord -
func (r *Repository) NewRecord() *record.AccountRole {
	return &record.AccountRole{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.AccountRole {
	return []*record.AccountRole{}
}

// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.AccountRole, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.AccountRole, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.AccountRole) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.AccountRole) error {
...
func (r *Repository) CreateTestRecord(rec *record.AccountRole) error {
