...
// NewRecord -
func (r *Repository) NewRecord() *record.Account {
	return &record.Account{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.Account {
	return []*record.Account{}
}

// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.Account, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.Account, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.Account) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.Account) error {
...
func (r *Repository) CreateTestRecord(rec *record.Account) error {
