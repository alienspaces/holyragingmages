...
import (
	...
	"gitlab.com/alienspaces/holyragingmages/service/spell/internal/harness"
...
func TestCreateOne(t *testing.T) {
	...
	for _, tc := range tests {
		...
		func() {
			...
			// repository
			r := h.Model.(*model.Model).SpellRepository()
