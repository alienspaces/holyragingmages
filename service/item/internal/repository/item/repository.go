...
// NewRecord -
func (r *Repository) NewRecord() *record.Item {
	return &record.Item{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.Item {
	return []*record.Item{}
}
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.Item, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.Item) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.Item) error {
...
func (r *Repository) CreateTestRecord(rec *record.Item) error {
